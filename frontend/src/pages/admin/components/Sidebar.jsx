...
function Sidebar({ activeTab, setActiveTab, sidebarOpen, setSidebarOpen }) {
  ...
  const menuItems = [
    ...
    { id: 'students', label: 'Students', icon: GraduationCap, color: '#3b82f6' },
    { id: 'companies', label: 'Companies', icon: Building2, color: '#10b981' },
    { id: 'jobs', label: 'Jobs', icon: Briefcase, color: '#8b5cf6' },
    { id: 'drives', label: 'Placement Drives', icon: Calendar, color: '#ec4899' },
          ...
          <div style={styles.logoContainer}>
            ...
            {sidebarOpen && (
              <div>
                ...
                <span style={styles.logoSub}>Placement Portal</span>
              </div>
            )}
          </div>
          <button 
